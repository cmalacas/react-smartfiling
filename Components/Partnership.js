            ...
            <Fragment>
                ...
                <Card className="mb-30">
                    <CardBody>
                        ...
                        <h2>Partnership Tax ID (EIN) Application</h2>
                        ...
                        <FormGroup>
                            ...
                            />
                            { this.state.errorCompanyName ? <div className="invalid-feedback">Name of Partnership is required</div> : '' }                               
                ...
                <Card className="mb-30">
                    <CardBody>
                        ...
                        <Row>
                            <Col>
                                <h2>General Partner Information</h2>
                            </Col>
                        </Row>
