            ...
            <Fragment>
                ...
                <Card className="mb-30">
                    <CardBody>
                        ...
                        <h2>Church Organization Tax ID (EIN) Application</h2>
                ...
                <Card className="mb-30">
                    <CardBody>
                        ...
                        <Row className="mb-15">
                            <Col>Is the Mailing Address different than the above address?</Col>
                        </Row>
                ...
                <Card className="mb-30">
                    <CardBody>
                        ...
                        <FormGroup row>
                            <Col>
                                <Label>What State was the Organization formed in?</Label>
                                <SelectState 
                ...
                <Card className="mb-30">
                  <CardBody>
                    ...
                    <FormGroup row>
                        <Col>
                            <Label>Date Organization Started or Acquired:</Label>
                            <Input 
                                type="date" 
                                name="dateStarted" 
                                onChange={ this.change } 
