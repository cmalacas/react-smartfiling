      ...
      <Row className="ein-container">
        ...
        <Col md={8} className="pr-30">
...

          {
            ...
            : this.state.entityType === 'Corporation' || this.state.entityType === 'S-Corporation' ?

              <Corporation
                entityType = { this.state.entityType }
              />

            : this.state.entityType === 'Partnership' ?

              <Partnership
                entityType = { this.state.entityType }
              />

            : this.state.entityType === 'Non-Profit Organization' ?

              <Nonpro
                entityType = { this.state.entityType }
              />

            : this.state.entityType === 'Church Organization' ?
