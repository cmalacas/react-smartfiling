...
export default class Nonpro extends Component {
    ...
    next() {
        ...
        let errorOrganizationType = false;
    ...
    render() {
        ...
        const types = ["Select an Option", "Homeowners/Condo Association", "IRA", "Memorial or Scholarship Fund", "Political Organization", "PTA/PTO or School Organization", "Sports Teams (community)", "Other Non-Profit Organization"];
            ...
            <Fragment>
                ...
                <Card className="mb-30">
                    <CardBody>
                        ...
                        <FormGroup>
                            ...
                            />
                            { this.state.errorCompanyName ? <div className="invalid-feedback">Corporation Name is required</div> : '' }                               
                        ...
                        <FormGroup row>
                            ...
                            <Col>
                                <Label>Type of Non-Profit Organization</Label>
                                <Input 
                                    type="select"
                                    ...
                                    onChange={ this.change }
                                    tabIndex={3}
                                    className={ this.state.errorOrganizationType ? 'invalid' : '' }
                                >
                                  { types.map(type => <option key={type} value={type}>{type}</option>)}
                                </Input>
                                { this.state.errorOrganizationType ? <div className="invalid-feedback">Type of Non-Profit Organization is required</div> : '' }                               
                            </Col>
                ...
                <Card className="mb-30">
                    <CardBody>
                        ...
                        <h2>Organization Address (PO Boxes Not Allowed)</h2>
                        ...
                        <Row className="mb-15">
                            <Col>Is Mailing Address different than the Organization Address?</Col>
                        </Row>
